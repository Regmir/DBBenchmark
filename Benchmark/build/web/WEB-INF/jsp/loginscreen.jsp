<%-- 
    ...
    Created on : 06.09.2017, 12:36:17
    Author     : Acer
--%>
...
<!DOCTYPE html>
<title>Login</title>
<form class="cd-form floating-labels" method="post" action="/Benchmark/Log.htm">
	<fieldset>
	<legend>Login</legend>
	<div>
        <h4>Login</h4>
        <input type="text" required value="Insert login here" id="log" name="login"/>
	</div>
        <div>
        <h4>Password</h4>
        ...
        <div>
            Not registered?<a href="Register.htm">Create an account</a>
	</div>
        <div>
