...
<form class="cd-form floating-labels" method="post" action="/Benchmark/Action.htm">
	<fieldset>
	<legend>Menu</legend>
	<div>
	<h4>Query type</h4>
	...
	<li>
            <input type="radio" name="query" value="Create" id="cd-radio-1" checked>
            <label for="cd-radio-1">Create</label>
	</li>
	<li>
            <input type="radio" name="query" value="Read" id="cd-radio-2">
            <label for="cd-radio-2">Read</label>
	</li>
        <li>
            <input type="radio" name="query" value="Update" id="cd-radio-3">
            <label for="cd-radio-3">Update</label>
	</li>
        <li>
