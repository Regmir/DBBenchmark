<%-- 
    Document   : register
    Created on : 06.09.2017, 13:20:50
    Author     : Acer
--%>
...
<form class="cd-form floating-labels" method="post" action="/Benchmark/Reg.htm">
	<fieldset>
	<legend>Register</legend>
	<div>
        <h4>Login</h4>
        <input type="text" required value="Insert login here" id="login" name="login"/>
	</div>
        <div>
        <h4>Password</h4>
        <input type="password" required value="password" id="pas" name="pas"/>
	</div>
        <div>
        <h4>E-mail</h4>
        <input type="text" required value="Insert e-mail here" id="email" name="email"/>
	</div>
        <div>
            Already registered? <a href="Login.htm">Sign in</a>
	</div>
        <div>
